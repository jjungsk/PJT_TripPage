...
<section class="container px-4 px-lg-5 mt-5 pt-5 justify-content-center">
  ...
  <script>
       ...
       document.querySelector("#btn-mv-register").addEventListener("click", function () {
         location.href = "${root}/board?act=mvwrite&pgno="+pageno+"&key="+"${param.key}"+"&word="+"${param.word}";
       });

       document.querySelector("#btn-search").addEventListener("click", function () {
         let form = document.querySelector("#form-search");
           form.setAttribute("action", "${root}/board?act=");
           form.submit();
       });
    ...
    function getTarget(page) {
    	fetch("${root}/board?act=listcontent&pgno="+page)
